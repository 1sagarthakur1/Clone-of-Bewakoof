...
let Navbar = () => {
    ...
    <div is="left_pull">
        ...
        <a id="L1_anchor" href="./offers.html">Offers</a>
        <a id="L_anchor" href="#">Fanbook</a>
        <a id="L_anchor" href="./app.html">Download App</a>
        <a id="L_anchor" href="#">Tribe Membership</a>



    </div>
    <div id="right_pull">
        <a id="R_anchor" href="#">Contact Us</a>
        <a id="R2_anchor" href="#">Track Order</a>
    </div>
</div>
...
<div id="lower_navbar">
    ...
    <!-- <div id="diff_pages">
        ...
        <span id="Capitals">
            <a id="LN_anchor" href="#">MENS</a>
        </span>
        <span id="Capitals">
            <a id="LN_anchor" href="#">WOMENS</a>

        </span>
        <span id="Capitals">
            <a id="LN_anchor" href="#">MOBILE COVERS</a>
...
<li><a href="mens.html">MEN</a>
    ...
    <div id="fd_div">
        <div id="sd_div">
            <img id="searchImage" src="https://images.bewakoof.com/web/ic-web-head-search.svg" alt="">
            <input id="searchInput" type="text" placeholder="search by product,category or collection">
        </div>
    </div>
    ...
    <div id="bg_lg_ws_div">
     ...
     <a href="login.html"><img id="login_image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCZRlg8mnfMUt1JGRPhcN332hk1qbaqGPTpA&usqp=CAU" alt=""></a>       
